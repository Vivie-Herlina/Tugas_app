...
public class hal_ekstravaganza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hal_ekstravaganza);

        final ImageView vector = findViewById(R.id.vector);
    ...
    private void spin() {
        ...
        rotateAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                Toast.makeText(hal_ekstravaganza.this, "Selamat Untuk Penukaran Pada Bulan Ini Senilai " +sectors[sectors.length - (degree + 1)] + " point.", Toast.LENGTH_SHORT).show();
                isSpinning = false;
    ...
    public void backk(View v) {
        Intent intent = new Intent(hal_ekstravaganza.this, masukhal.class);
